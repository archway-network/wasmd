...
var _ types.WasmerEngine = GasTrackingWasmEngine{}

func NewGasTrackingWasmEngine(vm types.WasmerEngine, gasRegister wasmkeeper.WasmGasRegister) GasTrackingWasmEngine {
